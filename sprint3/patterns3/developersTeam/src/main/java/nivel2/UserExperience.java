...
public class UserExperience {
	...
	private final String PEDIR_ELECCION = "\nEscoge una opcion introduciendo el numero: ";
	...
	private final String[] STOCK_MENU_OPT = {"1. Stock de flores", "2. Stock de arboles", 
											"3. Stock de objetos de decoracion", "4. Stock general"};
	private final String[] PRODUCT_MENU_OPT = {"1. Flor", "2. Arbol", "3. Objeto de decoracion"};
	
	private final String[] TICKET_MENU = {"1. Mostrar Ticket de ventas", "2. Mostrar facturacion total"};
	
	private final String INVALID_OPTION = "No es una opcion valida.";
	private final String UNEXPECTED_VALUE = "No es un valor valido";
	
	private Scanner sc = new Scanner(System.in);
	private final String HEAD = "Bienvenido al gestor de floristeria";
	...
	public int askOptionNumberBetween(int numOpciones) {
		...
		System.out.println("Por favor introduce un numero segun la opcion escogida: ");
		while(!valorCorrecto) {
			System.out.print("> ");
			if(sc.hasNextInt()) {
				opcion = sc.nextInt();
